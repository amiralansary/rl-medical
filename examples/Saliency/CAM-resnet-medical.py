    ...
    def _build_graph(self, inputs):
        ...
        with argscope(Conv2D, nl=tf.identity, use_bias=False,
            ...
            logits = (LinearWrap(convmaps)
                      ...
                      # .FullyConnected('linearnew', 2, nl=tf.identity)())
...
def get_data(train_or_test):
    ...
    ds = CamCAN(datadir, shuffle=isTrain)
...
def viz_cam(model_file, data_dir):
    ...
    for inp, outp in pred.get_result():
        ...
        for i in range(batch):
            ...
            classname = gender[labels[i]]
            cv2.imwrite('file-cam-{}-{}.jpg'.format(cnt, classname), concat)
            cnt += 1
            if cnt == 500:
                return
