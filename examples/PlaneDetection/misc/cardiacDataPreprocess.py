...
def play(sitk_image3d, origin_image3d,
        plane_norm, plane_origin, plane_size,
...
if __name__ == "__main__":
    ...
    for i in range(train_files.num_files):
        ...
        # read images
        data_2ch_gt = sitk.GetArrayFromImage(sitk_image_2ch)[0,:,:].T
        ...
        plane_3ch_params = get2DPlaneFrom3DImageGivenTwoNiftis(
