...
def get_player(directory=None, viz=False, train=False):
    ...
    if not train:
        ...
        pl = HistoryFramePlayer(pl, hist_len=FRAME_HISTORY, concat_axis=2)# concat_axis=2 for 3d states
...
class Model(DQNModel):
    ...
    def _get_DQN_prediction(self, image):
        ...
        with argscope(Conv2D, nl=PReLU.symbolic_function, use_bias=True), \
            ...
            l = (LinearWrap(image)
                 # Nature architecture
                 .Conv2D('conv0', out_channel=32, kernel_shape=16, stride=8)
...
if __name__ == '__main__':
    ...
    if args.task != 'train':
        ...
        logger.set_logger_dir( 'train_log/DQN_fetal_US_2D_75'
